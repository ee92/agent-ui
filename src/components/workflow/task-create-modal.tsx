        ...
        <div className="space-y-4 px-5 py-4">
          <div>
            ...
            <input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="What needs to be done?" autoFocus
              ...
              className="w-full rounded-lg border border-white/10 bg-black/30 px-3 py-2.5 text-sm text-white outline-none focus:border-blue-500/50" />
          </div>
          ...
          {sessionKey && (
            <div className="rounded-lg border border-white/5 bg-black/20 px-3 py-2">
              <p className="text-[11px] font-medium uppercase tracking-wider text-zinc-500">Linked Session</p>
