        ...
        <div className="space-y-4 px-5 py-4">
          <div>
            ...
            <input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="What needs to be done?" autoFocus
              ...
              className="w-full rounded-lg border border-white/[0.06] bg-surface-1 px-3 py-2.5 text-sm text-white outline-none focus:border-blue-500/50" />
          </div>
          ...
          <div>
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={3} placeholder="Context, details, links..."
              className="w-full rounded-lg border border-white/[0.06] bg-surface-1 px-3 py-2 text-sm text-white outline-none focus:border-blue-500/50" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select value={status} onChange={(e) => setStatus(e.target.value as TaskStatus)}
                className="w-full rounded-lg border border-white/[0.06] bg-surface-1 px-3 py-2 text-sm text-white outline-none">
          ...
          {sessionKey && (
            <div className="rounded-lg border border-white/[0.06] bg-surface-1 px-3 py-2">
